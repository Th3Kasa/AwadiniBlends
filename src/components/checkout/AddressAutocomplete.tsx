  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {!error && value.length > 0 && value.length < 4 && (
        <p className="text-xs text-cream/30 mt-1.5">Keep typing to search…</p>
      )}
      ...
      {showDropdown && (
        <ul
          ...
          className="absolute z-50 mt-1 w-full rounded-md border border-white/10 bg-[#161616]
            shadow-xl shadow-black/50 overflow-hidden divide-y divide-white/5"
        >
          {hasResults ? (
            <>
              {suggestions.map((s, i) => (
            ...
            <li className="px-4 py-4">
              <p className="text-sm text-cream/50 mb-1">Address not found in our lookup.</p>
              <p className="text-xs text-cream/35 leading-5">
