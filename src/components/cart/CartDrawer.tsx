...
export function CartDrawer() {
  ...
  const bundleLabel   = getBundleLabel(totalQty);
  // How many more to reach the next tier
  const toNextFree    = totalQty < 3 ? 3 - totalQty : 0;

  // Subtotal uses the bundle-discounted price, not the base $12
